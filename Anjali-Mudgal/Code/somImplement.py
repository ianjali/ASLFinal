...
class MiniSomImplement:
    def __init__(self, n_neurons, m_neurons, input_len, sigma=1.5, learning_rate=0.5,
    ...
    def train(self, data, n_iterations):
        for i in range(n_iterations):
            ...
            input_vect = data[rand_i] #take random point from data
            bmu = self.find_winner(input_vect) #find winner neuron
            #update the weights of winning neuron
    ...
    def cal_learning_rate(self, t, max_iter):
        ...
        is a function of max_teration and current iteration since the learning rate
        ...
        for i in range(self.n_neurons):
            for j in range(self.m_neurons):
                ...
                if self.neighborhood_function == 'gaussian':
                    ...
                    raise ValueError('Please choose the neighborhood from guassian and mexican_hat')
