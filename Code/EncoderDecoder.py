...
def trainEncoderDecoderWithTarget(x_train,y_train,x_test,y_test):
    ...
    return history,autoencoder_model,encoder_model,decoder_model
def getEncoderDecoderWithTarget():
    ...
    return autoencoder_model,encoder_model
def trainEncoderDecoderWithTargetIncresedDimesnion(x_train,y_train,x_test,y_test):
    ...
    #     restore_best_weights=True
    # )
    autoencoder_model.load_weights('autoencoder_model1_.h5')
    history = autoencoder_model.fit(x_train, y_train, epochs=40,  validation_data=(x_test, y_test))
